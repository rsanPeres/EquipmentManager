        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name_Equipment_Model = table.Column<string>(type: "varchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Id_EquipmentPositionHistory", x => new { x.EquipmentId, x.DateRegisteredPosition });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Id_EquipmentStateHistory", x => new { x.EquipmentStateId, x.EquipmentId });
                    table.ForeignKey(
